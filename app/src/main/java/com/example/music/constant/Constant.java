...
public class Constant {
    ...
    public static final String PAGE_FACEBOOK = "https://www.facebook.com/ktqdNEU";
    public static final String LINK_FACEBOOK = "https://www.facebook.com/ktqdNEU";
    public static final String LINK_YOUTUBE = "https://www.facebook.com/ktqdNEU";
    public static final String PHONE_NUMBER = "+0333144559";
    public static final String GMAIL = "NEU@gmail.com";
    public static final String SKYPE_ID = "";
    public static final String ZALO_LINK = "https://www.facebook.com/ktqdNEU";

    // Firebase url
    public static final String FIREBASE_URL = "https://musicapp-8ffd0-default-rtdb.firebaseio.com";
